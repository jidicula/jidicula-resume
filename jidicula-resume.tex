...
{ Blog: \urlstyle{same}\href{http://bit.ly/jidicula-site}{\bf forcepush.tech}
  ...
  | \href{mailto:resume@johanan.dev}{resume@johanan.dev}
...
\location{Nov 2021--Jul 2022 | Remote}
\vspace{\topsep} % Hacky fix for awkward extra vertical space
\begin{tightemize}
\item Guided client teams in migrating their application workloads to Microsoft Azure effectively.
\end{tightemize}
\sectionsep{}
