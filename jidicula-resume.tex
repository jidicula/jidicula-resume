...
\begin{tightemize}
\item Shipping platform features and bugfixes for GitHub's GraphQL API, including safe GraphQL gem upgrades, performance and availability improvements, and database optimizations.
